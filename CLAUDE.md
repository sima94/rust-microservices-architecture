...
- See `docker/CLAUDE.md` for Patroni, HAProxy, and PgBouncer details
...
section for each service's CLAUDE.md. The agent implements those tests and code that passes them.
...
7. Write Required Tests in the service's `CLAUDE.md`
